...
//        rout_var[i].dt_discharge[0] = 0.0;
//        cshift(rout_var[i].dt_discharge, options.IUH_NSTEPS, 1, 0, 1);
//    }
//
//    // Alloc
...
//            global_param.dt;
//        for (j = 0; j < options.IUH_NSTEPS; j++) {
//            dis_local[i][j] = rout_var[i].dt_discharge[j];
//        }
...
//    for (i = 0; i < local_domain.ncells_active; i++) {
//        for (j = 0; j < options.IUH_NSTEPS; j++) {
//            rout_var[i].dt_discharge[j] = dis_local[i][j];
//        }
